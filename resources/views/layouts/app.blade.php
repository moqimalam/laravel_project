...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>{{ !empty($meta_title) ? $meta_title : "KidKinder" }} </title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta name="keywords" content="{{ !empty($meta_description) ? $meta_description : "KidKinder" }}" />
    <meta name="description" content="{{ !empty($meta_keyword) ? $meta_keyword : "KidKinder" }}" />
