            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" value="{{ $getRecord['slug'] }}" name="slug" id="inputEmail4">
                  </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control tinymce-editor" name="description" cols="30" rows="5">{{ $getRecord['description'] }}</textarea>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="meta_description" cols="30" rows="3">{{ $getRecord['meta_description'] }}</textarea>
                </div>
                <div class="col-12">
