            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="post" action="" enctype="multipart/form-data" >
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" value="{{ $getRecord->profession }}" name="profession" id="inputEmail4">
                </div>

                <div class="col-12">
                    <label for="inputEmail4" class="form-label">Message</label>
                    <textarea name="message" class="form-control" cols="30" rows="10">{{ $getRecord->message }}</textarea>
                </div>
